      ...
      <div className="flex-1 flex flex-col p-5 sm:p-6">
        ...
        <div className="flex gap-3 mt-4 pt-4 border-t border-slate-100 dark:border-slate-700">
          <Link
            ...
            className="flex-1 text-center rounded-lg border-2 border-primary-600 dark:border-primary-500 text-primary-600 dark:text-primary-400 font-semibold py-2.5 text-sm hover:bg-primary-50 dark:hover:bg-primary-950/30 transition-colors"
          >
            {t("OPEN_CAUSES_DONATE_BTN_LABEL")}
          </Link>
          <Link
            href={`/cause/${cause.unique_title}`}
            className="flex-1 flex items-center justify-center gap-1.5 rounded-lg bg-primary-600 hover:bg-primary-700 text-white font-semibold py-2.5 text-sm"
          >
